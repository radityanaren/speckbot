...
class SkillsLoader:
    ...
    def _parse_skill_metadata(self, raw: str) -> dict:
        """Parse skill metadata JSON from frontmatter (supports speckbot and openclaw keys)."""
        try:
            data = json.loads(raw)
            return data.get("speckbot", data.get("openclaw", {})) if isinstance(data, dict) else {}
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get speckbot metadata for a skill (cached in frontmatter)."""
